...
plt.axhline(y=300, color='black', linestyle='dashed', linewidth=2, alpha=0.65, zorder=1)
...
plt.plot(x, z, c='black', alpha=1, linewidth=3, zorder=4, label = '_nolegend_')
# plt.scatter(x, z, marker='o', s=30, c='white', zorder=4, edgecolor='black', label = '_nolegend_')


x_p = np.linspace(x[0],x[-1],num)
plt.fill_between(x_p, 0, -100, alpha=1, color='whitesmoke', hatch='//', edgecolor='lightgray')
